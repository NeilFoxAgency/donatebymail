...
97. **Hosted — PARTIAL.** Always Use HTTPS, TLS 1.2 minimum, one-year HSTS with subdomains, and nosniff are enabled. Managed WAF is unavailable on the current Cloudflare Free plan and would require an explicit paid-plan decision.
