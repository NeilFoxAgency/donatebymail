...
export function StaffPage() {
  ...
  return <main className="operations-main"><section className="operations-shell"><div className="staff-heading"><div><p className="kicker">Beta operations</p><h1>Donation management</h1><p className="staff-role">Signed in as {isAdmin ? "administrator" : "operations staff"}.</p></div><button className="button text" onClick={() => void logout().finally(() => { setStaffRole(null); setAuthenticated(false); })}>Sign out</button></div>
